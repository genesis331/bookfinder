            ...
            <div className="mt-10">
              <div>
                <div class="hidden md:flex">
                  <input type="text" placeholder="Enter Book Name or ISBN" id="hs-trailing-button-add-on-with-icon" name="hs-trailing-button-add-on-with-icon" class="py-4 px-8 block w-full border-gray-200 focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:bg-dark-field dark:border-gray-700 dark:text-dark-text-less-emphasis placeholder:text-dark-text-less-emphasis"/>
                  <button type="button" class="inline-flex flex-shrink-0 justify-center items-center h-[4rem] w-[4rem] border border-transparent font-semibold bg-light-component-less-emphasis dark:bg-dark-component-less-emphasis text-white hover:bg-zinc-700 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-sm" onClick={() => {navigate("/book")}}>
                ...
                <div className="flex flex-col gap-5 md:hidden">
                  <input type="text" placeholder="Enter Book Name or ISBN" class="py-3 px-4 block w-full h-[3rem] text-sm border-gray-200 focus:border-blue-500 focus:ring-blue-500 dark:bg-dark-field dark:border-gray-700 dark:text-gray-400 placeholder:text-center" onClick={() => {navigate("/book")}}/>
